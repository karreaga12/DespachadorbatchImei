...
import claro.com.ec.listener.JobListener;
import claro.com.ec.models.Persona;
import claro.com.ec.processor.PersonaItemProcessor;
	  ...
	  private StepBuilderFactory stepBuilderFactory;
		...
		public FlatFileItemReader<Persona> reader(){
			return new FlatFileItemReaderBuilder<Persona>()
					...
					.resource(new ClassPathResource("archivo.csv"))
					.delimited()
